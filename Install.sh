...
#create_loading_dialog
echo "$PASSWORD" | sudo -S rm -rf /Users/$current_user/Macblox_Build
echo "$PASSWORD" | sudo -S rm -rf /Users/$current_user/Macblox_Build.zip
echo "[INFO] Building MacBlox"
# Download the repository as a ZIP file
curl -L -o /Users/$current_user/Macblox_Build.zip https://github.com/SomeRandomGuy45/Macblox_Build/archive/refs/heads/main.zip
...
echo "$PASSWORD" | sudo -S mv "/Users/$current_user/Macblox_Build-main/Macblox_${TYPE}"/* /Applications/Macblox
sleep 1
#close_loading_dialog
